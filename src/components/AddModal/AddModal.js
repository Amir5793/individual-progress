...
export default function AddModal({ isTargetModal, isTaskModal, setTargets, setTasks, showModal, setShowModal }) {
    let color = "blue"
    let [error, setError] = useState(null)
    const input = useRef(null)
    const Add = () => {
        // Adds a task or target into display and also localstorage
    ...
    return (
        <div className="modal-container">
            ...
            <div className="header">
                <h1>Enter the {isTargetModal && "target"}{isTaskModal && "task"} title and time</h1>
            </div>
            <div className="body">
